...
Under the "Advanced" options, set an environment variable called `MOVIE_API_KEY` (specifying your own API Key value, without quotes). Also set an environment called `SECRET_KEY` and specify your own unique value.
